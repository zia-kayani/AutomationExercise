...
class TestCheckout:
    ...
    def test_register_and_login_and_place_order_and_verify_success(self, page,comment,name,card,cvc,month,year, user_data
    ):
    ...
    def test_login_and_place_order_and_verify_success(self, page,comment,name,card,cvc,month,year, registered_user
    ):
        ...
        auth_flow.login_with_credentials(registered_user["email"], registered_user["password"])
        auth_flow.verify_logged_in() , "Account is not logged in "
